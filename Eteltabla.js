...
export default class FetchExample extends React.Component {
  ...
  fetch("http://10.153.224.223:3000/tipus", {
      method: "POST",
  ...
  componentDidMount(){
    return fetch('http://10.153.224.223:3000/etel')
    ...
    return(
      <View style={{flex: 1, paddingTop:20}}>
        ...
        <FlatList
          ...
          <Image  source={{uri: 'http://10.153.224.223:3000/'+item.etel_kep}} style={{width:300,height:300,marginLeft:"auto",marginRight:"auto"}} />       
          </View>
